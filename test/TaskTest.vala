...
public class TaskTest : Gee.TestCase {

    public static void main (string[] args) {
        Test.init (ref args);

        TestSuite.get_root ().add_suite (new TaskTest ().get_suite ());
    ...
    public TaskTest () {
        base ("Task");
        add_test ("with_attributes", with_attributes);
        add_test ("to_string", to_string);
        add_test ("from_string", from_string);
